...
namespace Oceyra.Dbml.Generator.Samples.Migrations.TaskManagerDb
{
    ...
    [Migration("20250725130004_UseIndexAsCompositePrimaryKey")]
    partial class UseIndexAsCompositePrimaryKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Oceyra.Dbml.Generator.Samples.TaskDependency", b =>
                {
                    ...
                    b.HasKey("TaskId", "DependencyTaskId", "ProjectId")
                        .HasName("public_index_1");
            ...
            modelBuilder.Entity("Oceyra.Dbml.Generator.Samples.TaskResult", b =>
                {
                    ...
                    b.HasIndex("TaskId", "AgentType", "ProjectId")
                        .IsUnique()
                        .HasDatabaseName("public_idx_task_results_task_id_agent_type");
